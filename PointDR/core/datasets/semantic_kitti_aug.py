...
class AugSemanticKITTI(dict):
    ...
    def __init__(self, root, voxel_size, num_points, **kwargs):
        ...
        super().__init__({
            'train': AugSemanticKITTIInternal(root, voxel_size, num_points, weak_aug, strong_aug, sample_stride=1, split='train'),
            'test': AugSemanticKITTIInternal(root, voxel_size, num_points, weak_aug, strong_aug, sample_stride=sample_stride, split='val')
        })


class AugSemanticKITTIInternal:
