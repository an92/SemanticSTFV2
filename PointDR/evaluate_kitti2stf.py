...
def main() -> None:
    ...
    parser.add_argument('--config', default="/home/SemanticSTFV2/PointDR/configs/test.yaml",
                        help='config file')
    parser.add_argument('--checkpoint_path', default="/home/SemanticSTFV2/runs/pointdr_63456867/checkpoints/epoch-12.pt",
