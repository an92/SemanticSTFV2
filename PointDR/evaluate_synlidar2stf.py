...
def main() -> None:
    ...
    parser.add_argument('--config', default="/home/SemanticSTFV2/PointDR/configs/synlidar2stf/minkunet/cr0p5.yaml", help='config file')
    parser.add_argument('--checkpoint_path', default="/home/SemanticSTFV2/runs/synlidar-to-semanticstf.pt", help='checkpoint_path')
