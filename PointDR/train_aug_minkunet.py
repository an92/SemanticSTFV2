...
from PointDR.core.raw_minkunt_trainers import RawMinkUnetTrainer
...
def main() -> None:
    ...
    if args.run_dir is None:
        args.run_dir = auto_time_set_run_dir()
    else:
    ...
    trainer = RawMinkUnetTrainer(model=model, criterion=criterion, optimizer=optimizer, scheduler=scheduler, num_workers=configs.workers_per_gpu, seed=seed, amp_enabled=configs.amp_enabled)
