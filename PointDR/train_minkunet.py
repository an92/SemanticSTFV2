...
def main() -> None:
    ...
    parser.add_argument('--config', default='/home/SemanticSTFV2/PointDR/configs/rawkitti2stf/minkunet/cr0p5.yaml', help='config file')
    ...
    trainer = RawMinkUnetTrainer(model=model,
                                 criterion=criterion,
                                 optimizer=optimizer,
                                 scheduler=scheduler,
                                 num_workers=configs.workers_per_gpu,
