...
from PointDR.core.minkunt_v1_trainers import MinkUnetV1Trainer
...
def main() -> None:
    ...
    parser.add_argument(
        '--config',
        default='/home/SemanticSTFV2/PointDR/configs/aug_minkunet_v1.yaml',
        help='config file',
    )
    parser.add_argument('--run-dir', default='minkunet_v1', help='run directory')
