...
from PointDR.core.minkunt_v2_trainers import MinkUnetV2Trainer
...
def main() -> None:
    ...
    parser.add_argument(
        '--config',
        default='/home/SemanticSTFV2/PointDR/configs/aug_minkunet_v2.yaml',
        help='config file',
    )
    parser.add_argument('--run-dir', default='minkunet_v2', help='run directory')
